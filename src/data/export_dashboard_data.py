...
# ESPN headshot IDs — verified from actual ESPN profile page URLs
# ESPN URL format: https://a.espncdn.com/combiner/i?img=/i/headshots/nfl/players/full/{id}.png&w=350&h=254
# Verified ESPN profile-page IDs (confirmed from espn.com/nfl/player/_/id/…)
ESPN_HEADSHOT_IDS = {
    "J.Allen": 3918298,
    "L.Jackson": 3916387,
    "J.Burrow": 3915511,
